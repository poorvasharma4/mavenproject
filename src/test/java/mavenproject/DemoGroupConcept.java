...
public class DemoGroupConcept {
	...
	@Parameters({ "firstname", "lastname", "phone", "email", "address", "city", "state", "postal", "country",
	...
	@AfterMethod
	public void captureSc(String screenshot) throws IOException {
